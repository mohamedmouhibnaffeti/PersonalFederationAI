...
const ChartThreeCopy: React.FC<any> = ({personalityDistribution}: {personalityDistribution: Array<any>}) => {
  ...
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-4">
      ...
      <div className="-mx-8 flex flex-wrap items-center justify-center gap-y-3">
        ...
        <div className="w-full px-8 sm:w-1/2">
          <div className="flex w-full items-center">
            <span className="mr-2 block h-3 w-full max-w-3 rounded-full bg-[#6577F3] min-w-3"></span>
            <p className="flex w-full justify-between text-sm font-medium text-black dark:text-white">
